...
b (6.000 | 1.000)b (5.000 | 1.000)b (4.000 | 1.000)b (2.000 | 2.001);;;; Solution Found
; States evaluated: 9
; Cost: 3.002
; Time 0.00
0.000: (navigation nav marker1 marker2 hnt)  [1.000]
0.000: (find_hint nav marker1 hnt)  [1.000]
1.001: (reason hnt hyp marker2 nav)  [1.000]
